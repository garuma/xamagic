...
namespace MagicalKingdom
{
	public class XamarinSpinnerView : View
	{
		...
		void Initialize ()
		{
			...
			var rotation = ObjectAnimator.OfFloat (this, "rotation", 0, 120);
		...
		void DrawHexagon (Canvas canvas)
		{
			...
			if (hexagonPaint == null) {
				...
				hexagonPaint.SetPathEffect (new CornerPathEffect (TypedValue.ApplyDimension (ComplexUnitType.Dip, 2, Resources.DisplayMetrics)));
			}
